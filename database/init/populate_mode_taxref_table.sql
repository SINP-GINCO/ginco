...
SELECT 'TaxRefValue', taxref.cd_nom, coalesce(taxref.cd_taxsup, rtf.cd_taxsup), taxref.cd_nom, taxref.lb_nom, taxref.nom_complet, taxref.nom_vern, '0', case when (taxref.cd_nom = taxref.cd_ref) then 1 else 0 end
