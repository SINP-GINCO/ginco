...
INSERT INTO referentiels.liste_referentiels (table_name,label,description,"version","type","name",updated_at,url) VALUES (
  'codemaillevalue','Grille nationale, mailles 10km x 10km','Ce référentiel compile les grilles 10km x 10km des territoires métropolitain et d’outre-mer. ','2011-2012','referentiel','MAILLES_10x10','2012-01-01','https://inpn.mnhn.fr/telechargement/cartes-et-information-geographique/ref/referentiels');
INSERT INTO referentiels.liste_referentiels (table_name,label,description,"version","type","name",updated_at,url) VALUES (
