INSERT INTO application_parameters (name, value, description) VALUES
  ('CAS_login_url', 'https://preprod-inpn.mnhn.fr/auth/login', 'CAS login URL'),
  ('CAS_validation_url', 'https://preprod-inpn.mnhn.fr/auth/serviceValidate', 'CAS validation URL'),
  ('CAS_logout_url', 'https://preprod-inpn.mnhn.fr/auth/logout', 'CAS logout URL'),
