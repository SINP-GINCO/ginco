...
INSERT INTO unit VALUES
    ...
    ('TypeSolValue', 'CODE', 'DYNAMIC', 'Type de sol observé', 'Type de sol observé'),
    ('GeologieValue', 'CODE', 'DYNAMIC', 'Type de géologie de la zone', 'Type de géologie de la zone'),
...
INSERT INTO table_field ("data",format,column_name,is_calculated,is_editable,is_insertable,is_mandatory,"position") VALUES 
    ...
    ('techniquecollecte','table_habitat','techniquecollecte','1','1','1','1',7),
...
INSERT INTO table_field ("data",format,column_name,is_calculated,is_editable,is_insertable,is_mandatory,"position") VALUES
    ...
    ('dspublique','table_station','dspublique','1','1','1','1',3),
    ...
    ('geometrie','table_station','geometrie','1','1','1','1',26),
    ('natureobjetgeo','table_station','natureobjetgeo','1','1','1','1',27),
...
INSERT INTO file_field ("data",format,is_mandatory,mask,label_csv) VALUES 
    ...
    ('techniquecollecte','file_habitat','0',NULL,'techniqueCollecte'),
    ...
    ('geometrie','file_station','1',NULL,'WKT'),
    ...
    ('dspublique','file_station','0',NULL,'dSPublique'),
