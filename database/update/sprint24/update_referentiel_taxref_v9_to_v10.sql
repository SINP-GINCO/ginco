-- --------------------------------------------------
-- DROP v9 table in referentiels
-- --------------------------------------------------

DROP TABLE referentiels.taxref;
DROP TABLE referentiels.taxref_rang;
DROP TABLE referentiels.taxref_statut;


-- --------------------------------------------------
-- Création des tables du référentiel TAXREF (V10)
-- --------------------------------------------------
