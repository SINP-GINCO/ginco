...
try {
	...
	$identifiantPermanentMandatory = "UPDATE metadata.file_field SET is_mandatory=0 WHERE data='identifiantpermanent';
			UPDATE metadata_work.file_field SET is_mandatory=0 WHERE data='identifiantpermanent';
			UPDATE metadata.table_field SET is_calculated=1 WHERE data='identifiantpermanent';
			UPDATE metadata_work.table_field SET is_calculated=1 WHERE data='identifiantpermanent';
			UPDATE metadata.table_field SET is_editable=0 WHERE data='identifiantpermanent';
			UPDATE metadata_work.table_field SET is_editable=0 WHERE data='identifiantpermanent';";
