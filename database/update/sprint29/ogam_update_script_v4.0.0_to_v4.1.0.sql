...
ALTER TABLE website.predefined_request_group_asso_old RENAME CONSTRAINT predefined_request_group_asso_request_name_fkey TO fk_predefined_request_request_name_old;
ALTER TABLE website.predefined_request_criterion_old RENAME CONSTRAINT pk_predefined_request_criteria TO pk_predefined_request_criterion_old;
ALTER TABLE website.predefined_request_criterion_old RENAME CONSTRAINT predefined_request_criterion_request_name_fkey TO fk_predefined_request_criterion_request_name_old;
ALTER TABLE website.predefined_request_column_old RENAME CONSTRAINT pk_predefined_request_result TO pk_predefined_request_column_old;
