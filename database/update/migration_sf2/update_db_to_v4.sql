...
INSERT INTO metadata.dynamode (unit, sql) VALUES
  ...
  ('StatutSourceValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.StatutSourceValue ORDER BY code'),
  ('DSPubliqueValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.DSPubliqueValue ORDER BY code'),
  ('StatutObservationValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.StatutObservationValue ORDER BY code'),
  ('ObjetDenombrementValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.ObjetDenombrementValue ORDER BY code'),
  ('TypeDenombrementValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.TypeDenombrementValue ORDER BY code'),
  ('CodeHabitatValue', 'SELECT lb_code as code, lb_code as label, lb_description, ''''::text as position FROM referentiels.habref_20 GROUP BY lb_code having count(lb_code)>1'),
  ('CodeRefHabitatValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.CodeRefHabitatValue ORDER BY code'),
  ('NatureObjetGeoValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.NatureObjetGeoValue ORDER BY code'),
  ('TypeENValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.TypeENValue ORDER BY code'),
  ('CodeHabRefValue', 'SELECT cd_hab as code, cd_hab as label, lb_description, ''''::text as position FROM referentiels.habref_20 ORDER BY code'),
  ('IDCNPValue', 'SELECT code as code, label as label, definition, ''''::text as position FROM referentiels.IDCNPValue ORDER BY code'),
  ('TypeInfoGeoValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.TypeInfoGeoValue ORDER BY code'),
  ('VersionMasseDEauValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.VersionMasseDEauValue ORDER BY code'),
  ('NiveauPrecisionValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.NiveauPrecisionValue ORDER BY code'),
  ('SensibleValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.SensibleValue ORDER BY code'),
  ('SensibiliteValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.SensibiliteValue ORDER BY code'),
  ('TypeRegroupementValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.TypeRegroupementValue ORDER BY code'),
  ('OccurrenceNaturalisteValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.OccurrenceNaturalisteValue ORDER BY code'),
  ('OccurrenceSexeValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.OccurrenceSexeValue ORDER BY code'),
  ('OccurrenceStadeDeVieValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.OccurrenceStadeDeVieValue ORDER BY code'),
  ('OccurrenceStatutBiologiqueValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.OccurrenceStatutBiologiqueValue ORDER BY code'),
  ('PreuveExistanteValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.PreuveExistanteValue ORDER BY code'),
  ('ObservationMethodeValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.ObservationMethodeValue ORDER BY code'),
  ('OccurrenceEtatBiologiqueValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.OccurrenceEtatBiologiqueValue ORDER BY code'),
  ('OccurrenceStatutBiogeographiqueValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.OccurrenceStatutBiogeographiqueValue ORDER BY code'),
  ('PROVIDER_ID', 'SELECT id as code, label, , definition, ''''::text as position FROM website.providers ORDER BY label'),
  ('SensiAlerteValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.SensiAlerteValue ORDER BY code'),
  ('SensiManuelleValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.SensiManuelleValue ORDER BY code'),
  ...
  ('TypeAttributValue', 'SELECT code as code, label || '' ('' || code || '')'' as label, definition, ''''::text as position FROM referentiels.typeattributvalue ORDER BY code');
