 ...
 */
Ext.define('OgamDesktop.ux.picker.TimeRange', {
    extend:'Ext.Panel',
    alias: 'widget.timerangepicker',
    alternateClassName:['OgamDesktop.ux.picker.TimeRangePicker'],
    ...
    onOkButtonPress: function(button, state) {
        if (state) {
            this.fireEvent('select', this, {
                startTime : this.minField.getValue(),
                endTime : this.maxField.getValue()
            });
        }
    },
