...
use Ign\Bundle\GincoBundle\Entity\Mapping\LayerTreeNode;
use Ign\Bundle\GincoBundle\Entity\Mapping\ProviderMapParameters;
use Ign\Bundle\GincoBundle\Entity\Mapping\ZoomLevel;
...
class MapController extends GincoController {
	...
	public function ajaxgetlayertreenodesAction(Request $request) {
		...
		return $this->render('IgnGincoBundle:Map:ajaxgetlayertreenodes.json.twig', array(
