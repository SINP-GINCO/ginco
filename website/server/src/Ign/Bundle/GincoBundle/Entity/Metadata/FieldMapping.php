...
class FieldMapping {
	...
	/**
	 *
	 * @var string @ORM\Column(name="src_data", type="string", length=36, nullable=false)
	 *      @ORM\Id
	...
	/**
	 *
	 * @var string @ORM\Column(name="src_format", type="string", length=256, nullable=false)
	 *      @ORM\Id
	 *     
	 */
	private $srcFormat;
	...
	/**
	 *
	 * @var string @ORM\Column(name="dst_data", type="string", length=36, nullable=false)
	 *      @ORM\Id
	...
	/**
	 *
	 * @var string @ORM\Column(name="dst_format", type="string", length=256, nullable=false)
	 *      @ORM\Id
	...
	/**
	 * The type of the mapping (FILE or FORM).
	 * 
	 * @var string @ORM\Column(name="mapping_type", type="string", length=36, nullable=false)
	 */
	private $mappingType;
