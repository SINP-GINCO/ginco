...
class QueryController extends GincoController {
	...
	public function ajaxgetdatasetsAction(Request $request) {
		...
		return new JsonResponse($this->get('ogam.manager.query')->getDatasets($this->getUser()));
	}
	...
	public function createPredefinedrequestAction(Request $request) {
	    ...
	    try{
    	    ...
    	    $this->get('ogam.query_service')->updatePredefinedRequest ($pr, $r->get('datasetId'), $r->get('label'), $r->get('definition'), $r->getBoolean('isPublic'), $this->getUser());
