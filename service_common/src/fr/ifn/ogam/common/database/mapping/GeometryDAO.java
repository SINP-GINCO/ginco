...
public class GeometryDAO {
	 ...
	 * @throws Exception
	 */
	public void createGeometryLinksFromGeometry(String format, String tableName, Map<String, Object> parameters, Connection con) throws Exception {
		...
		try {
			...
			stmt.append("AND m.provider_id = '" + parameters.get(DSRConstants.PROVIDER_ID) + "' RETURNING id_geometrie;");
	 ...
	 * @throws Exception
	 */
	public void createGeometryLinksFromCommunes(String format, String tableName, Map<String, Object> parameters, Connection con) throws Exception {
		...
		try {
			...
			stmt.append("AND bac.id_commune = ANY (m.codecommune::text[]) RETURNING id_geometrie;");
	 ...
	 * @throws Exception
	 */
	public void createGeometryLinksFromMailles(String format, String tableName, Map<String, Object> parameters, Connection con) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void createGeometryLinksFromDepartements(String format, String tableName, Map<String, Object> parameters, Connection con) throws Exception {
		...
		try {
			...
			stmt.append("WHERE m.ogam_id_" + format + " = '" + parameters.get(DSRConstants.OGAM_ID) + "' ");
			stmt.append("AND m.provider_id = '" + parameters.get(DSRConstants.PROVIDER_ID) + "' ");
			stmt.append("AND bac.id_departement = ANY (m.codedepartement::text[]) RETURNING id_geometrie;");
